...
the list of model_name = [detr, ssd, fasterrcnn, yolov5, yolor, efficientdet]
"""
...
if __name__ == '__main__':
    ...
    if model=='detr':
    	...
    	os.system('python detect.py --source image_location --weights model_location --conf-thres 0.5')
        
    elif model=='yolor':
    	import os
    	yolor_path = ''
    	os.chdi(yolor_path)
    	os.system('python detect.py --source image_location --cfg cfg/yolor_p6.cfg --weights model_location --conf 0.5 --img-size 640 --device 0')
